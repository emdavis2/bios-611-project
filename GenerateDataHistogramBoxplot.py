...
file_lines.append('pval for solidity={}'.format(pval))
...
file_lines.append('pval for velocity={}'.format(pval))
...
file_lines.append('pval for vx={}'.format(pval))
...
file_lines.append('pval for vy={}'.format(pval))
...
file_lines.append('pval for absskew={}'.format(pval))
#plt.text(.2, 2, 'statistic={}, pvalue={}'.format(round(tstat,3),round(pval,5)), fontsize = 8, bbox = dict(facecolor = 'red', alpha = 0.1))
...
file_lines.append('pval for dx={}'.format(pval))
#plt.text(.1, 12/10, 'statistic={}, pvalue={}'.format(round(tstat,3),round(pval,5)), fontsize = 8, bbox = dict(facecolor = 'red', alpha = 0.1))
...
file_lines.append('pval for dy={}'.format(pval))
#plt.text(.1, 12/10, 'statistic={}, pvalue={}'.format(round(tstat,3),round(pval,5)), fontsize = 8, bbox = dict(facecolor = 'red', alpha = 0.1))
...
file_lines.append('pval for speed={}'.format(pval))
...
file_lines.append('pval for D/T={}'.format(pval))
...
file_lines.append('pval for FMI={}'.format(pval))
